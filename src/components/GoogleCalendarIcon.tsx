...
/**
 * Ícone oficial do Google Agenda (Google Calendar)
 */
export function GoogleCalendarIcon({ size = 16, className = '' }: GoogleCalendarIconProps) {
  return (
    <svg 
      viewBox="0 0 200 200" 
      width={size} 
    ...
    >
      <g transform="translate(3.75 3.75)">
        ...
        {/* Canto inferior esquerdo verde escuro */}
        <path fill="#188038" d="M-3.75,148.882v31.579c0,8.724,7.066,15.789,15.789,15.789h31.579v-47.368H-3.75z" />
        {/* Direita amarelo */}
        <path fill="#FBBC04" d="M148.882,43.618v105.263h47.368V43.618l-23.684-10.526L148.882,43.618z" />
        {/* Canto superior direito azul escuro */}
